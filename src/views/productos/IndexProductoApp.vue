        ...
        <div class="container">
            <div class="row">
                ...
                <div class="sidebar col-xl-3 col-lg-4 order-lg-1">
                                                ...
                                                <div class="sidebar-menu-item mb-2 active" data-bs-toggle="collapse" :data-bs-target="'#subcategories_'+index" aria-expanded="true" :aria-controls="'subcategories_'+index" role="menuitem">
                                                    <a class="nav-link active" href="#!">
                                                        <div class="row">
                                                            ...
                                                            <div class="col" style="text-align: right !important;"><img src="/assets/media/flecha-curva.png" style="width:10px" alt=""></div>
                                                        </div>
                    ...
                    <div class="sidebar-block px-3 px-lg-0 me-lg-4"> <a class="d-lg-none block-toggler" data-bs-toggle="collapse" href="#sizeFilterMenu" aria-expanded="false" aria-controls="sizeFilterMenu">Almacenamiento</a>
                        <!-- Size filter menu-->
                        <div class="expand-lg collapse" id="sizeFilterMenu"> 
                        <h6 class="sidebar-heading d-none d-lg-block">Almacenamiento </h6>
                        <form class="mt-4 mt-lg-0" action="#">  
                            <div class="mb-1">
                            <div class="form-check">
                                <input class="form-check-input" id="size0" type="radio" value="128" name="size" v-on:change="selectedStorage($event)">
                                <label class="form-check-label" for="size0">128gb</label>
                            </div>
                            </div>
                            <div class="mb-1">
                            <div class="form-check">
                                <input class="form-check-input" id="size1" type="radio" value="256" name="size" v-on:change="selectedStorage($event)">
                                <label class="form-check-label" for="size1">256gb</label>
                            </div>
                            </div>
                            <div class="mb-1">
                            <div class="form-check">
                                <input class="form-check-input" id="size2" type="radio" value="512" name="size" v-on:change="selectedStorage($event)">
                                <label class="form-check-label" for="size2">512gb</label>
                            </div>
                            </div>
                            <div class="mb-1">
                            <div class="form-check">
                                <input class="form-check-input" id="size3" type="radio" value="1TB" name="size" v-on:change="selectedStorage($event)">
                                <label class="form-check-label" for="size3">1tb</label>
                            </div>
                            </div>
                        </form>
                        </div>
                    ...
                    <div class="sidebar-block px-3 px-lg-0 me-lg-4"><a class="d-lg-none block-toggler" data-bs-toggle="collapse" href="#colourFilterMenu" aria-expanded="false" aria-controls="colourFilterMenu">Colores</a>
                        ...
                        <div class="mt-4 mt-lg-0"> 
                            ...
                            <li class="list-inline-item">
                                <label class="btn-colour" for="colour_sidebar_White" style="background-color: #fff" v-on:click="selectedColor('BLANCO')"> </label>
                                <input class="input-invisible" type="checkbox" name="colour" value="Blanco" id="colour_sidebar_Blanco" >
                            </li>
                            <li class="list-inline-item">
                                <label class="btn-colour" for="colour_sidebar_Violet" style="background-color: #969696" v-on:click="selectedColor('GRIS')"> </label>
                                <input class="input-invisible" type="checkbox" name="colour" value="Gris" id="colour_sidebar_Gris" >
                            </li>
                            <li class="list-inline-item">
                                <label class="btn-colour" for="colour_sidebar_Red" style="background-color: #ff0004" v-on:click="selectedColor('ROJO')"> </label>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            selectedColor(value){
                this.productos = this.productos_const.filter(item=>item.variedades.some(subitem=>subitem.variacion== value));
            },
            selectedStorage(event){
                this.productos = this.productos_const.filter(item=>item.variedades.some(subitem=>subitem.variacion== event.target.value));
            }
        },
        watch: {
            $route (to,from){
