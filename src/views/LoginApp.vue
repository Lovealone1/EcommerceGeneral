            ...
            <div class="container">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="block-body">
                        <p class="text-muted">Para acceder a tu cuenta, por favor ingresa tu correo electrónico y contraseña en los campos provistos a continuación.</p>
                        <hr>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="block-body"> 
                        <p class="text-muted">Registrate para disfrutar de una experiencia de compra personalizada, acceso a tu historial de pedidos y la posibilidad de recibir ofertas exclusivas.</p>    
                        <hr>
                        <form action="customer-orders.html" method="get">
                        <div class="mb-4">
